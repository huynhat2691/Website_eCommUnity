...
const AdminDashboardAdminOrders = () => {
  const { adminOrders, adminOrdersLoading } = useSelector(
    (state) => state.order
  );
  ...
  const filterOrders = (status) => {
    if (status === "all") return adminOrders;
...
export default AdminDashboardAdminOrders;
