...
const AdminAddProducts = () => {
  ...
  useEffect(() => {
    ...
    if (success) {
      ...
      dispatch(resetAdminAddProductSuccess());
    }
  ...
  const handleSubmit = (e) => {
    ...
    if (productToUpdate) {
      ...
      dispatch(adminAddProduct(newForm));
    }
  };
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <DialogContent className="max-w-[960px] max-h-[700px]">
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid grid-cols-3 gap-4 border rounded-md p-2">
                    ...
                    {categoryPath[1] && categoryPath[1].subclassifications && (
                            ...
                            {categoryPath[1].subclassifications.map(
                              (subclassification) => (
                                <li
                                  ...
                                  onClick={() =>
                                    handleCategorySelect(subclassification, 2)
                                  }
                                  className={`cursor-pointer ${
                                    categoryPath[2]?.id === subclassification.id
                                      ? "font-bold text-[#27b3e2]"
                                      : ""
          ...
          <div className="flex items-center justify-end">
            <Link to="/admin/admin-products" className="mr-4">
