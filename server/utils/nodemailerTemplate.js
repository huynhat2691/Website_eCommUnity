const activationEmailTemplate = (userName, activationUrl) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        <div class="header">
            <h1>Kích hoạt tài khoản eCommUnity</h1>
            <img src="./assets/logo3.png" width="200px" alt="">
        </div>
        <div class="content">
            <h2>Xin chào ${userName},</h2>
            <p>Cảm ơn bạn đã đăng ký tài khoản. Để kích hoạt tài khoản của bạn, vui lòng nhấp vào nút bên dưới:</p>
